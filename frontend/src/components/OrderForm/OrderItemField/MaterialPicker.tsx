...
import { GetAllMaterials, GetAllMaterials_getAllMaterials } from '../../../__generated__/types';
import { GET_ALL_MATERIALS } from '../../Material/queries';

export const MaterialPicker: React.FC<{ name: string }> = ({ name }) => {
	const { t } = useTranslation();
	const [filteredItems, setFilteredItems] = useState<GetAllMaterials_getAllMaterials[]>([]);
